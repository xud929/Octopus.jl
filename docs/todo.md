...
> | Audit the strong-strong solver stack | **open (2026-08-03)** | ~13,000 lines of `src/tasks/strongstrong/` were **not inspected** by the 2026-08-03 audit, which reached 16% of `src/`. Last reviewed 2026-07-24 and 2026-07-26. The three defects found this time were each a *cross-product* — two features that work alone, combined in a way no doc section covers — which is the shape to look for there. |
