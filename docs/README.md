...
- [`twiss_dispersion_analysis.md`](design/twiss_dispersion_analysis.md) — the
  ...
  (stages 1 to 6 landed 2026-09-11 to 2026-09-13; stage 7, the
  lattice_cells.jl refactor, optional; stage 8, the external benchmarks,
  next).
...
- Solver optimization histories:
  ...
  [`multi_process_step4f_gpic_2026_09_05.md`](history/multi_process_step4f_gpic_2026_09_05.md)
  ...
  for bit, the rank curve that follows),
